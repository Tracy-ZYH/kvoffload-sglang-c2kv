...
class ModelRunner(ModelRunnerKVCacheMixin):
    ...
    def forward_c2kv_repair_extract(
        ...
        history_kv_selectable_relative_indices=None,
        history_kv_mandatory_relative_indices=None,
        history_kv_recovery_mode: str = None,
        history_kv_recovery_relative_indices=None,
        ...
        return self.model.generate_raw_repair_kv(
            ...
            history_kv_selectable_relative_indices=(history_kv_selectable_relative_indices),
            history_kv_mandatory_relative_indices=(history_kv_mandatory_relative_indices),
